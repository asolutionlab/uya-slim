...
ASTNode *ast_new_node(ASTNodeType type, int line, int column, Arena *arena, const char *filename) {
    ...
    switch (type) {
        ...
        case AST_INTERFACE_DECL:
            ...
            node->data.interface_decl.composed_interfaces = NULL;
            node->data.interface_decl.composed_count = 0;
        ...
        case AST_STRUCT_DECL:
            ...
            break;
        case AST_UNION_DECL:
            node->data.union_decl.name = NULL;
            node->data.union_decl.variants = NULL;
        ...
        case AST_METHOD_BLOCK:
            ...
            node->data.method_block.union_name = NULL;
