...
- `CALL_EXTERN dst?, extern_id, arg_base, arg_count`
...
对于 hosted `run/test`，建议支持一个受控 extern bridge：

- `extern "libc"` / 少量 `extern fn`
- 使用预注册 ABI 签名桥接到宿主函数
